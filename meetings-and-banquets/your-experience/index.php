...
<title>Meeting Room Services - Omega Regency</title>
...
<h5><a href="http://www.kawdo.com/susara/omega/meetings-and-banquets/receive-a-quote/index.php" class="list-group-item">RECEIVE A QUOTE </a></h5>
 ...
 <h1>MEETING ROOM SERVICES </h1>
 <ol class="breadcrumb" >
    <li><a href="../../dining/index.php">Home</a>    </li>
    <li class="active">Meetings & Banquets</li>   
</ol>

<p>Omega Regency’s team of event coordinators are always on hand to assist with organizing every aspect of an event from decors & flowers to menus & entertainment. </p>

<p>Meeting room services include: </p>
<ul>
   <li> Wi-Fi broadband</li>
   <li> Refreshment bar with special rates</li>
  <li>  Team of F & B personnel and chefs to create individual menus</li>
  <li>  Registration areas</li>
 <li>   In-house technical team for IT and Multimedia support</li>
</ul>
