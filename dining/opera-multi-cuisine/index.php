...
<title>Opera Multi Cuisine - Omega Regency</title>
...
<div class="container-edit" >
 <div class="col-sm-3" style="margin-top: 60px;" >
     ...
     <a href="http://www.omegaregency.lk/dining/alindaya/index.php" style="text-decoration: none;"><button class="button button1 btn-block">ALINDAYA</button></a>

       <a href="http://www.omegaregency.lk/dining/spice-and-ice/index.php" style="text-decoration: none;"><button class="button button1 btn-block">SPICE & ICE  </button></a>
    
        <a href="http://www.omegaregency.lk/dining/opera-multi-cuisine/index.php" style="text-decoration: none;"><button class="button button1 btn-block">OPERA MULTI CUISINE </button></a>
 ...
 <h1>OPERA MULTI CUISINE </h1>
   ...
   <ol class="breadcrumb" >
    ...
    <li class="active">Opera Multi Cuisine </li>   
</ol>
