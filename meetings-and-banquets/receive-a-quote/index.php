...
<div class="panel panel-default">
  ...
  <form  method="POST" name="quotefrm" action="<?php $_PHP_SELF ?>">
 
      
      <div class="col-sm-6" >
<div class="form-group">
<input name="fname" type="text"  class="form-control1" placeholder="First Name" value=''/> <br>
</div>
          <div class="form-group">
<input name="surname" type="text" class="form-control1"  placeholder="Surname" value=''/><br>
          </div>
          <div class="form-group">
<textarea name="address" cols="" rows="" class="form-control1" placeholder="Address" value=''></textarea><br>
          </div>
          <div class="form-group">
<input name="postcode" type="text" class="form-control1" placeholder="Postcode"  value=''/><br>
          </div>
          <div class="form-group">
<input name="city" type="text" class="form-control1" placeholder="Town / City"  value=''/><br>
          </div>
<div class="form-group select1">
<select name="country" class="form-control1" placeholder="Country" value=''>
...
<br>
<div class="form-group">
<input name="state" type="text" class="form-control1" placeholder="State"  value=''/><br>
</div>
<div class="form-group">
 <input name="email" type="text"  class="form-control1" placeholder="Email *" value=''/><br>
    ...
    <div class="col-sm-6" >
      <div class="form-group">  
<input name="phone" type="text" class="form-control1" placeholder="Phone" value=''/><br>
      </div>
        <div class="form-group">
<input name="fax" type="text" class="form-control1"  placeholder="Fax" value=''/><br>
        </div>
        <div class="form-group">
<input name="companyname" type="text"  class="form-control1" placeholder="Company Name" value=''/><br>
        </div>
        <div class="form-group">
<input name="job" type="text" class="form-control1" placeholder="Job Title" value=''/><br>
        </div>
        <div class="form-group">
<input name="event" type="text" class="form-control1" placeholder="Event Industry" value=''/><br>
        </div>
        <div class="form-group">
<input name="organisation" type="text" class="form-control1" placeholder="Organisation Web Address" value=''/><br>
        </div>
 <div class="form-group">
  <p>
